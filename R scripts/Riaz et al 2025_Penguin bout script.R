...
pdf("FigS1l.pdf", width = 9, height = 4, onefile = FALSE)
FigS1
dev.off()
...
ModelPlot1 <- ggplot(data = x, aes(x = Year, y = fit)) +
  ...
  geom_errorbar(aes(ymin=fit-se, ymax=fit+se, colour = Year), width=0.4, size = 1, position = position_dodge(0.4)) +
  scale_fill_brewer(palette = "Set1", labels=c('2019/20', '2021/22')) +  
  scale_colour_brewer(palette = "Set1", labels=c('2019/20', '2021/22')) +
  # theme(legend.position = "none") +
...
ModelPlot2 <- ggplot(data = x, aes(x = Year, y = fit)) +
  geom_point(aes(colour = Year, fill = Year), size = 3, position = position_dodge(0.4)) +
  labs(y= "Inter-bout duration (mins)", x= "Year")  + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),  panel.border = element_rect(colour = "black")) + theme(legend.text = element_text(face = "italic")) +  theme(legend.title = element_blank(), legend.position = "right") +
  geom_errorbar(aes(ymin=fit-se, ymax=fit+se, colour = Year), width=0.4, size = 1, position = position_dodge(0.4)) +
  scale_fill_brewer(palette = "Set1", labels=c('2019/20', '2021/22')) +  
  scale_colour_brewer(palette = "Set1", labels=c('2019/20', '2021/22')) +
  theme(legend.position = "none") +
...
ModelPlot4 <- ggplot(data = x, aes(x = Year, y = fit)) +
  geom_point(aes(colour = Year, fill = Year), size = 3, position = position_dodge(0.4)) +
  labs(y= "Bout duration (mins)", x= "Year")  + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),  panel.border = element_rect(colour = "black")) + theme(legend.text = element_text(face = "italic")) +  theme(legend.title = element_blank(), legend.position = "right") +
  geom_errorbar(aes(ymin=fit-se, ymax=fit+se, colour = Year), width=0.4, size = 1, position = position_dodge(0.4)) +
  scale_fill_brewer(palette = "Set1", labels=c('2019/20', '2021/22')) +  
  scale_colour_brewer(palette = "Set1", labels=c('2019/20', '2021/22')) +
  theme(legend.position = "none") +
...
ModelPlot5 <- ggplot(data = x, aes(x = Year, y = fit)) +
  geom_point(aes(colour = Year, fill = Year), size = 3, position = position_dodge(0.4)) +
  labs(y= expression ("PCA rate (PCA "* min^-1 *")"), x= "Year")   + theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),  panel.border = element_rect(colour = "black")) + theme(legend.text = element_text(face = "italic")) +  theme(legend.title = element_blank(), legend.position = "right") +
  geom_errorbar(aes(ymin=fit-se, ymax=fit+se, colour = Year), width=0.4, size = 1, position = position_dodge(0.4)) +
  scale_fill_brewer(palette = "Set1", labels=c('2019/20', '2021/22')) +  
  scale_colour_brewer(palette = "Set1", labels=c('2019/20', '2021/22')) +
  theme(legend.position = "none") 
